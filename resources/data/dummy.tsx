...
export const artists = [
  ...
  },
  {
    ...
    name: 'Bruno M',
    style: 'Kuduro',
    about: 'Kudurista que empulsionou o Kuduro blblbla',
    songs: [SongTest, SongTest, SongTest],
...
export const chats_notifications = [
  {
    id: 1,
    user: 'Eduardo Quintas',
    type: 'Mensagem',
    picture_profile: artist1,
    messages: [
      {
        date: '01/06/2023',
        time: '00:34',
        files: { coverart: Fones, artistImage: artist1 },
      },
    ],
  },
  {
  ...
  {
    id: 3,
    user: 'Notificação Lifter',
    type: 'Notificação',
    picture_profile: lifter_smal_logo,
    messages: [
      {
        date: '01/06/2023',
        time: '08:00',
...
export const messages = [
  {
    message: 'Lorem ipsum dolor sit, amet consectetur adipisicing elit. Totam labore pariatur corrupti distinctio ad porro minus odio, quaerat in? Voluptate rem reiciendis natus inventore, impedit voluptatem quia voluptatibus aut expedita?',
    time: '21:00'
  },
  {
    message: 'Lorem ipsum dolor sit, amet consectetur adipisicing elit. Totam labore reiciendis natus inventore, impedit voluptatem quia voluptatibus aut expedita?',
    time: '21:00'
  },
  {
    message: 'Lorem ipsum dolor sit, amet consectetur adipisicing elit. Totam labore pariatur corrupti distinctio ad porro minus odio, quaerat in? Voluptate rem reiciendis natus inventore, impedit voluptatem quia voluptatibus aut expedita?',
  ...
  {
    message: 'Reiciendis natus inventore, impedit voluptatem quia voluptatibus aut expedita?',
    time: '21:00'
  },
  {
    message: 'Lorem ipsum dolor sit, amet consectetur adipisicing elit. Totam labore pariatur corrupti distinctio ad porro minus odio, quaerat in? Voluptate rem reiciendis natus inventore, impedit voluptatem quia voluptatibus aut expedita?',
