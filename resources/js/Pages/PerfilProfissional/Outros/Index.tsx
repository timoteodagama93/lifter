...
function Profissional() {
  ...
  const [profissional, setProfissional] = useState(
    page.props.profissional_account,
  );
  const [pagina, setPagina] = useState(<DetailsArtist artist={profissional} />);

  return (
    <div className="w-full h-full">
      <div className="relattive w-full h-full flex flex-col">
        <HeaderArtist profissional={profissional} setPagina={setPagina} />
        {pagina}
      </div>
    </div>
  );
...
function HeaderArtist({ profissional, setPagina }) {
      ...
      <div className="w-full flex flex-col">
        <div className=" flex flex-row justify-between items-center w-full  gap-1 border-b-2">
          <div className="flex flex-row gap-2 lg:gap-5 p-1 ">
            <button
              onClick={() => setPagina(<DetailsArtist artist={profissional} />)}
            ...
            {profissional.category === 'Produtora' ? (
              <button
                onClick={() => {
                  setCurrentPage(
                    <Index setPagina={setPagina} artist={profissional} />,
                  );
                }}
                className="text-sm md:text-3xl transform-effect p-1 flex flex-col lg:flex-row justify-center items-center"
              >
            ...
            <button
              onClick={() =>
                setPagina(<Index setPagina={setPagina} artist={profissional} />)
              }
            ...
            <button
              onClick={() => setPagina(<Marketing artist={profissional} />)}
            ...
            <button
              onClick={() => setPagina(<Stats artist={profissional} />)}
              className="text-sm md:text-3xl transform-effect p-1 flex flex-col lg:flex-row justify-center items-center gap-1"
            >
