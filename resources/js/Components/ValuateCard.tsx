...
function ValuateCard({ songs, category, setCategory }) {
  ...
  return (
    <>
                ...
                {isPlaying && activeSong?.artist != undefined ? (
                  <>
                    <Displayer
                      ...
                      isPlaying={isPlaying}
                      songs={songs}
                      setOpenValuation={setOpenValuation}
                    />
                    ,
                  </>
                ) : (
                      ...
                      <>
                        ...
                        >
                          <h1 className="text-center text-xl md:text-2xl">
                            {' '}
                            Nenhuma música em avaliação na categoria: {
                              category
                            }{' '}
                            .
                          </h1>
      ...
      {activeSong && activeSong.id != undefined && (
        <Valuate
          collectionType="song"
          collection={activeSong}
          isOpen={openValuation}
  ...
  return (
    ...
    >
      ...
      <div className="w-1/2 flex flex-col justify-between p-2">
        ...
        <button
          onClick={() => setOpenValuation(true)}
          className={`transform-effect w-full h-[10%] first-letter: rounded-lg flex-1 space-x-1 flex flex-row text-xl justify-center items-center mx-1 border-b-2 backdrop-blur-lg p-1 my-1 gap-1 bg-yellow-500 `}
        >
          <BiStar className="w-10 h-10" />
          <span>Avaliar música</span>
        </button>
      </div>
    </div>
  );
