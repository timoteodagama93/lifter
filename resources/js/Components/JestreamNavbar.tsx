    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="flex justify-between h-16">
        <div className="flex">
          ...
          <div className="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
            <NavLink
              href={route('top-talentos')}
              active={route().current('top-talentos')}
            >
              Top 100 Talentos
            </NavLink>
          </div>
          ...
          <div className="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
            <NavLink
              href={route('descobrir')}
              active={route().current('descobrir')}
            >
              Descobrir
            </NavLink>
          </div>
