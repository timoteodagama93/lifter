...
export default function ContestSchedule({ contest }: Props) {
  const form = useForm({
    _method: 'POST',
    id: contest?.id,
    inicio_inscricoes: contest?.inicio_inscricoes,    
    inicio_votacoes: contest?.inicio_votacoes,
    termino_inscricoes: contest?.termino_inscricoes,
    termino_votacoes: contest?.termino_votacoes,
    url_schedule: null as File | null,
  });
  const route = useRoute();
  const [photoPreview, setPhotoPreview] = useState<string | null>(contest.url_schedule);
