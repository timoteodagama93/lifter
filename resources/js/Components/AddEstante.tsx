...
export default function AddEstante({}) {
  ...
  return (
    <>
      {successOnAdd === true ? (
        <>
          <h1>Sua estante de livros foi criada com sucesso!</h1>
          <p>Adicione nela todos os seus livros, ensaios, poesias, etc.</p>
          ...
          <form onSubmit={onSubmit} className="">
            ...
            <div className="mt-4">
              <InputLabel htmlFor="title">
                Título da estante (coleção){' '}
              </InputLabel>
              <span className="hidden">Título da estante</span>
              <TextInput
                id="title"
                type="text"
            ...
            <div className="mt-4">
              <InputLabel htmlFor="producer">Autor (a) </InputLabel>
              <span className="">Responsável pela concepção</span>
              <TextInput
                id="producer"
                type="text"
                className="mt-1 block w-full"
                value={formSong.data.author}
                onChange={e =>
                  formSong.setData('author', e.currentTarget.value)
                }
                required
              />
              <InputError className="mt-2" message={formSong.errors.author} />
            </div>
            ...
            <div className="mt-4">
              <InputLabel htmlFor="letra">Descrição da da estante</InputLabel>
              <span>Opcional. </span>
              <textarea
                id="letra"
